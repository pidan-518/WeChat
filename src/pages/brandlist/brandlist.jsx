...
export default class index extends Component {
  ...
  componentDidMount () {
    console.log(this.$router.params.brandId,this.$router.params.name);
  ...
  getItemByBrandId(current){
    postRequest(servicePath.getItemByBrandId, {source:10,current,len:10,brandId:this.$router.params.brandId,
  ...
  render () {
    ...
    return (
      <View className='brandlist'>
        ...
        <View className="list">
          {
            ...
            list.map((item,index)=>{
              return <View key={item.id} className="goodItem" onClick={(e)=>this.getNavigateApp(e,item)}>
                <View className="bao">
        ...
        {/* 筛选 */}
        {
          isShowModal?<View className="model">
