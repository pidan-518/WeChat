...
// 品牌代购
class Activity9 extends Component {
  constructor(props) {
    super(props)
  ...
  onShareAppMessage() {
    ...
    return {
      title: '礼遇双旦，2021大礼包抢先领取！',
      path: `pageA/newyear/newyear?shareRecommend=${shareRecommend}`,
      imageUrl:
        'https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/share.jpg',
    }
  }
    ...
    return (
      <View id="activity9">
        {/* <View className="bg">
          <Image
            className="bg-img"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif"
          ></Image>
          <Image
            className="bg-img"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/bg.gif"
        ...
        <View className="firstScreen">
          {/* <Image
            className="firstScreen-img"
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/top.gif"
            lazyLoad={true}
          ></Image> */}
        </View>
        ...
        <View className="activityRule">
          <Image
            src="https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity9/rule2.png"
            className="rule"
            lazyLoad={true}
          ></Image>
        </View>
