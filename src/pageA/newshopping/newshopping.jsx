...
// 品牌代购
class Activity10 extends Component {
  constructor(props) {
    super(props)
  ...
  onShareAppMessage() {
    ...
    return {
      title: 'ICON MALL年货节 囤年货·迎新春·领福利·享优惠',
      path: `pageA/newyear/newyear?shareRecommend=${shareRecommend}`,
      imageUrl:
        'https://iconmall-developer.oss-cn-beijing.aliyuncs.com/png/small/activity10/share.jpg',
    }
  }
